...
define("EmailXMailer", "PHP v" . phpversion());
...
class Email {
    ...
    function Email($to = null, $from = null, $subject = null, $headers = null, $returnPath = null) {
        global $config;
        ...
        else if (!empty($config['return_path']))
            $this->ReturnPath = $config['return_path'];
        else
            $this->ReturnPath = __RETURN_PATH__;
...
//** generate a unique boundry identifier to separate attachments.
        ...
        return mail($this->To, $this->Subject, $thebody, $headers, "-f$this->ReturnPath");
    }
